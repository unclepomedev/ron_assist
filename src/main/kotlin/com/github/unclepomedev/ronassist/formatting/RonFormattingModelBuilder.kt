...
class RonFormattingModelBuilder : FormattingModelBuilder {
    ...
    override fun createModel(formattingContext: FormattingContext): FormattingModel {
        ...
        val block: Block = if (InjectedLanguageManager.getInstance(file.project).isInjectedFragment(file)) {
...
/**
 * Block that represents "do not touch this fragment" — used when the RON
 * code is injected into another language (Markdown fenced code blocks etc).
 */
